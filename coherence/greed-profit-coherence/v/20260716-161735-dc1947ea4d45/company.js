(function (root) {
  ...
  function diagnosticBadges(company, compact) {
    const sector = pillar(company, "sector");
    const sectorLimited = !sector || sector.coverage !== "complete" || sector.confidence === "low";
    ...
    return [
      ...
      expectationLabel,
      sectorLimited ? "업종 이력 제한" : "업종 비교 충분",
  ...
  function mount(container, context) {
    ...
    container.innerHTML = `<section class="company-workspace" data-workspace="company">
      ...
      <header class="workspace-heading company-heading">
        ...
        <div class="diagnostic-badges">${diagnosticBadges(company, compact)}</div>
      </header>
