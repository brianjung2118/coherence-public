(function (root) {
  ...
  const COMPONENT_HELP = {
    retail_post_count: "네이버 종목토론실에 한 달 동안 작성된 게시글 수입니다.",
    retail_views_per_post: "네이버 종목토론실의 한 달 전체 조회 수를 게시글 수로 나눈 값입니다.",
    retail_engagement_per_post: "네이버 종목토론실의 댓글·좋아요·싫어요 수를 게시글 수로 나눈 값입니다.",
    retail_post_acceleration: "이번 달 토론 글 수가 직전 6개월의 보통 수준보다 얼마나 늘거나 줄었는지 보여줍니다.",
    retail_heat_own_pct: "최근 12개월 중 이번 달 토론 글 수가 어느 정도로 높은지 나타낸 0~100점입니다.",
    retail_heat_market_pct: "같은 달 다른 종목과 비교한 토론 증가·조회·반응 수준의 0~100점입니다.",
    news_volume_acceleration: "이번 달 네이버 뉴스 기사 수가 이전 6개월의 보통 수준보다 얼마나 늘거나 줄었는지 보여줍니다.",
    ...
    attention_trading: "최근 거래량과 거래대금 회전이 다른 종목보다 얼마나 뜨거운지 나타낸 월간 점수입니다.",
    attention_retail_credit: "개인 순매수와 신용잔고가 다른 종목보다 얼마나 강한지 나타낸 월간 점수입니다.",
    attention_behavior: "최근 주가 상승과 고점 추격 움직임이 다른 종목보다 얼마나 강한지 나타낸 월간 점수입니다.",
    news_article_count: "네이버 뉴스에서 한 달 동안 수집된 해당 기업 기사 수입니다.",
